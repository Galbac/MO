...
async def import_admin_rankings(payload: dict | None = None) -> MessageResponse:
    return await service.import_rankings(payload or {})


@router.post("/recalculate-movements", response_model=MessageResponse)
async def recalculate_admin_ranking_movements() -> MessageResponse:
