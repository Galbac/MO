...
async def home(request: Request):
    return render(request, 'public/index.html', page_title='Makhachkala Open', page_name='home', section='public', description='Лайв-счета, рейтинги, новости, игроки и турниры Makhachkala Open.')
...
async def player_detail_page(request: Request, player_slug: str):
    return render(request, 'public/player-detail.html', page_title=f'Игрок - {player_slug}', page_name='player-detail', section='public', description=f'Профиль игрока {player_slug}.', entity_slug=player_slug)
...
async def tournament_detail_page(request: Request, tournament_slug: str):
    return render(request, 'public/tournament-detail.html', page_title=f'Турнир - {tournament_slug}', page_name='tournament-detail', section='public', description=f'Страница турнира {tournament_slug}.', entity_slug=tournament_slug)
...
async def match_detail_page(request: Request, match_slug: str):
    return render(request, 'public/match-detail.html', page_title=f'Матч - {match_slug}', page_name='match-detail', section='public', description=f'Лайв-счет, статистика и превью матча {match_slug}.', entity_slug=match_slug)
...
async def news_detail_page(request: Request, slug: str):
    return render(request, 'public/news-detail.html', page_title=f'Новость - {slug}', page_name='news-detail', section='public', description=f'Новостной материал: {slug}.', entity_slug=slug)
