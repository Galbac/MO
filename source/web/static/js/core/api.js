...
export const api = {
    ...
    users: {
        ...
        smartFeed: () => get("/users/me/smart-feed"),
        calendar: () => get("/users/me/calendar"),
        addReminder: (body) => post("/users/me/calendar/reminders", body),
        updateReminder: (id, body) => patch(`/users/me/calendar/reminders/${id}`, body),
        removeReminder: (id) => del(`/users/me/calendar/reminders/${id}`),
        ...
        pushSubscriptions: () => get("/users/me/push-subscriptions"),
        addPushSubscription: (body) => post("/users/me/push-subscriptions", body),
        removePushSubscription: (id) => del(`/users/me/push-subscriptions/${id}`),
        testPushSubscription: (body) => post("/users/me/push-subscriptions/test", body ?? {}),
    ...
    matches: {
        ...
        momentum: (id) => get(`/matches/${id}/momentum`),
